...
1. A brief API tutorial is [here](https://auscope.github.io/nvcl_kit/introduction.html)
...
Fazio, Vincent; Mule, Shane; Hunt, Alex; Jiang, Lingbo; Warren, Peter; Selvaraju, Venkataramanan; & Woodman, Stuart (2025): nvcl_kit: Access AuScope National Virtual Core Library (NVCL) data services. v8. CSIRO. Service Collection. http://hdl.handle.net/102.100.100/480016?index=1
